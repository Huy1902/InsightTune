...
\vspace{1.5cm}
	...
	\vspace{2cm}
{
{\textbf {\MakeUppercase{\fontsize{17}{17}\selectfont{Web quản lí tài chính cá nhân tích hợp AI}}}}\\[3pt]
...
\vspace{1.5cm}
		\begin{tabularx}
			{\linewidth}{>{\setlength\hsize{.0\hsize}}X>{\setlength\hsize{0.8\hsize}}X}
				& \parbox[t]{\hsize}{\fontsize{14}{14}\selectfont\textbf{Cán bộ hướng dẫn: TS. Nguyễn Đức Anh\\
				\hspace{6cm}ThS. Trần Mạnh Cường}}
		\end{tabularx}
